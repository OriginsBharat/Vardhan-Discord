...
REM Start IndexTTS Server
echo Starting IndexTTS Server...
for /f "tokens=1,* delims==" %%a in ('findstr /b "INDEXTTS_PATH" .env') do set INDEXTTS_PATH=%%b
start "IndexTTS" cmd /c "cd /d "%INDEXTTS_PATH%" && python app.py"
