...
class SetupWizard(ctk.CTk):
    ...
    def populate_all_fields(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Critical file not found: {os.path.join(BASE_DIR, 'MyAIWorld', 'data', 'character_canon.json')}")
    ...
    def begin_setup(self):
        ...
        with open(os.path.join(BASE_DIR, "MyAIWorld", "data", "character_kinks.json"), "w") as f:
